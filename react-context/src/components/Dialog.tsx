...
console.log('[Dialog]:[START]:[createContextScope]', DIALOG_NAME)
...
console.log('[Dialog]:[createDialogContext]', DIALOG_NAME)
...
const DialogTrigger = React.forwardRef<DialogTriggerElement, DialogTriggerProps>(
  (props: ScopedProps<DialogTriggerProps>, forwardedRef) => {
    ...
    console.log('[DialogTrigger]:useDialogContext', TRIGGER_NAME, __scopeDialog)
    const context = useDialogContext(TRIGGER_NAME, __scopeDialog);
    console.log('[DialogTrigger]:context', context)
...
console.log('[Dialog]:[createDialogContext]', PORTAL_NAME)
